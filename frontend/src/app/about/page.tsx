          ...
          <div className="card mb-6">
            ...
            <ul className="space-y-2 text-slate-600">
              {[
                ...
                'Маркировка рекламных материалов ERID (ФЗ-347)',
                'Реквизиты компании (ИНН, ОГРН, адрес, контакты)',
                'Документы для потребителей (оферта, возврат, доставка, оплата)',
                'Технические параметры (title, meta description, robots.txt, sitemap.xml)',
              ].map((item) => (
